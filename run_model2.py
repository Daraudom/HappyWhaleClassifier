...
transform = transforms.Compose([
    ...
    transforms.CenterCrop(224),  # or RandomCrop for training
...
wandb.init(
    ...
    name="Dommy-SpeciesDataset-hyperparameters_mod2", ##update this with your name
    config={"learning rate":.01, # possibly update
        "architecture": "CNN",
        "dataset": "Species",
        "epochs": 10, "batch_size":64}  # possibly update
) 
